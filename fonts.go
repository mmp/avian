...
var (
	...
	FontAwesomeIconBaby                = faUsedIcons["Baby"]
	...
	FontAwesomeIconGlobeAmericas       = faUsedIcons["GlobeAmericas"]
...
var (
	...
	faUsedIcons map[string]string = map[string]string{
		...
		"GlobeAmericas":       FontAwesomeString("GlobeAmericas"),
...
func (f *Font) createGlyph(ch rune) *Glyph {
	if ch == '\u200a' { // special case for thin space
		return &Glyph{Visible: false, AdvanceX: 1}
	}
